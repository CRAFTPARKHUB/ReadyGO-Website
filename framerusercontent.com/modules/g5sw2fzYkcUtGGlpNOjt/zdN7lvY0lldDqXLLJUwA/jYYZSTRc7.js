...
fontStore.loadFonts(["FS;Switzer-regular", "FS;Switzer-semibold", "Inter-BoldItalic", "Inter-Italic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
        family: "Switzer",
