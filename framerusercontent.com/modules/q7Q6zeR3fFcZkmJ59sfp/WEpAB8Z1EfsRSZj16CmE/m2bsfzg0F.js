...
fontStore.loadFonts(["FS;Switzer-medium", "Inter-Bold", "Inter-BoldItalic", "Inter-Italic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
        family: "Switzer",
