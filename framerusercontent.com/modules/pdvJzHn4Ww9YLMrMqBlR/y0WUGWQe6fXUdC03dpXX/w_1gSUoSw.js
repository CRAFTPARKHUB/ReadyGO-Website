...
fontStore.loadFonts(["FS;Switzer-semibold", "Inter-Black", "Inter-BlackItalic", "Inter-BoldItalic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
        family: "Switzer",
