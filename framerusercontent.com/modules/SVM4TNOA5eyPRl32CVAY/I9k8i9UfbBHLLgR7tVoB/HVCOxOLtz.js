...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    const href = useSVGTemplate("1964567075", svg);
    return /*#__PURE__*/ _jsx(SVG, { ...restProps,
        className: cx("framer-fmMdU", className),
        layoutId: layoutId,
        ref: ref,
        role: "presentation",
        style: {
...
const css = [`.framer-fmMdU { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`];
/**
 ...
 * @framerVector {"name":"Certificate","color":{"type":"variable","value":"21h8s6"},"set":{"localId":"vectorSet/NGVKdicsm","id":"NGVKdicsm","moduleId":"omX0gWFPqDwhaiWwf6ab"}}
 * @framerDisableUnlink true
 */
const Icon = withCSS(Component, css, "framer-fmMdU");
