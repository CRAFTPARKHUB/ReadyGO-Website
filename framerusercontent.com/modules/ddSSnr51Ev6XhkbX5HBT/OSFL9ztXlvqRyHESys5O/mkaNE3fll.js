...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    const href = useSVGTemplate("876389144", svg);
    return /*#__PURE__*/ _jsx(SVG, { ...restProps,
        className: cx("framer-BpUsM", className),
        layoutId: layoutId,
        ref: ref,
        role: "presentation",
        style: {
...
const css = [`.framer-BpUsM { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`];
/**
 ...
 */
const Icon = withCSS(Component, css, "framer-BpUsM");
Icon.displayName = "Seal Check";
export default Icon;
