...
fontStore.loadFonts(["FS;Switzer-regular", "FS;Switzer-semibold", "FS;Switzer-bold italic", "FS;Switzer-italic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
        family: "Switzer",
