...
const Component = /*#__PURE__*/ React.forwardRef(function(props, ref) {
    ...
    const href = useSVGTemplate("3494739676", svg);
    return /*#__PURE__*/ _jsx(SVG, { ...restProps,
        className: cx("framer-p3lRU", className),
        layoutId: layoutId,
        ref: ref,
        role: "presentation",
        style: {
...
const css = [`.framer-p3lRU { -webkit-mask: ${mask}; aspect-ratio: 1; display: block; mask: ${mask}; width: 24px; }`];
/**
 ...
 */
const Icon = withCSS(Component, css, "framer-p3lRU");
